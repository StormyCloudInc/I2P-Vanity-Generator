...
// sendResult attempts to send r to resultCh without blocking.
// It returns true if the value was delivered to the channel, or false if the context was done before the send could occur.
